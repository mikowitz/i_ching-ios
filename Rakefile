# -*- coding: utf-8 -*-
$:.unshift('/Library/RubyMotion4.3/lib')
...
# require 'bubble-wrap'
Motion::EnvironmentSettings.config_path=("config/environments")
...
Motion::Project::App.setup do |app|
  ...
  app.name = 'i_ching-ios'
  app.identifier = 'com.your_domain_here.i_ching-ios'
  ...
  app.development do
    ...
    app.provisioning_profile = "signing/i_ching-ios.mobileprovision"
